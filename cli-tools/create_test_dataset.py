...
@click.command()
@click.option("--frame_path", default="/home/mhess/kaggle-rsna/raw/stage_2_test_images_jpg/")
@click.option("--output_path", default="/home/mhess/kaggle-rsna/ml/s2_v1/data/test/")
