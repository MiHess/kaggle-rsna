...
@click.option("--raw_data_path", default="/home/mhess/kaggle-rsna/raw/")
@click.option("--output_path", default="/home/mhess/kaggle-rsna/ml/s2_v1/data/")
...
def main(limit, only_target_images, raw_data_path, output_path, test_fraction, label_map_filepath):
    ...
    train_dicom_dir = os.path.join(raw_data_path, 'stage_2_train_images_jpg')
    train_labels = os.path.join("/home/mhess/kaggle-rsna/raw/", 'stage_2_train_labels.csv')
